...
#include <MobileDeviceKit/AFCProtocol.h>
#else
#include "AFCTypes.h"
...
#define kAFCErrorInternal        AFCMakeDomainError(kAFCInternalError)
     ...
     */
    CFStringRef AFCCopyErrorString(AFCDomainError _err);
    
    /*!
     @function AFCCopyPacketTypeString
     @abstract Return a localized name for an AFC packet type.
     */
    CFStringRef AFCCopyPacketTypeString(uint64_t packetType);
    
        // MARK: - Synchronous interface -
     ...
     */
    const char *AFCGetClientVersionString(void);
    
    
        // MARK: Connections (Synchronous, deprecated)
     ...
     */
    __attribute__((deprecated)) AFCError AFCConnectionOpen(CFSocketNativeHandle fd, void *context, AFCConnectionRef *connOut) /* DEPRECATED_ATTRIBUTE */;
     ...
     */
    __attribute__((deprecated)) AFCError AFCConnectionClose(AFCConnectionRef conn) /* DEPRECATED_ATTRIBUTE */;
     ...
     */
    size_t AFCConnectionGetFSBlockSize(AFCConnectionRef conn);
     ...
     */
    size_t AFCConnectionGetSocketBlockSize(AFCConnectionRef conn);
     ...
     */
    AFCError AFCConnectionSetFSBlockSize(AFCConnectionRef conn, size_t blockSize) /* DEPRECATED_ATTRIBUTE */;
    ...
    /*!
     ...
     kAFCInvalidArgumentError will be returned.
     */
    AFCError AFCConnectionSetSocketBlockSize(AFCConnectionRef conn, size_t blockSize) /* DEPRECATED_ATTRIBUTE */;
     ...
     */
    AFCDomainError AFCConnectionGetStatus(AFCConnectionRef conn);
     ...
     */
    CFTypeRef AFCConnectionCopyLastErrorInfo(AFCConnectionRef conn);
    
        // MARK: Directories (Synchronous, deprecated)
     ...
     */
    __attribute__((deprecated)) AFCError AFCDirectoryOpen(AFCConnectionRef conn, const char *remotePath, AFCDirectoryRef *dirOut) /* DEPRECATED_ATTRIBUTE */;
     ...
     */
    __attribute__((deprecated)) AFCError AFCDirectoryRead(AFCConnectionRef conn, AFCDirectoryRef dir, char **nameOut) /* DEPRECATED_ATTRIBUTE */;
     ...
     */
    __attribute__((deprecated)) AFCError AFCDirectoryClose(AFCConnectionRef conn, AFCDirectoryRef dir) /* DEPRECATED_ATTRIBUTE */;
     ...
     */
    __attribute__((deprecated)) AFCError AFCDirectoryCreate(AFCConnectionRef conn, const char *remotePath) /* DEPRECATED_ATTRIBUTE */;
    
    
        // MARK: File operations (Synchronous, deprecated)
     ...
     */
    __attribute__((deprecated)) AFCError AFCDeviceInfoOpen(AFCConnectionRef conn, AFCKeyValueRef *kvOut) /* DEPRECATED_ATTRIBUTE */;
    ...
    /*!
     ...
     @result kAFCSuccess or a protocol error code.
     */
    __attribute__((deprecated)) AFCError AFCFileInfoOpen(AFCConnectionRef conn, const char *remotePath, AFCKeyValueRef *kvOut) /* DEPRECATED_ATTRIBUTE */;
     ...
     */
    __attribute__((deprecated)) AFCError AFCRemovePath(AFCConnectionRef conn, const char *remotePath) /* DEPRECATED_ATTRIBUTE */;
     ...
     */
    __attribute__((deprecated)) AFCError AFCRenamePath(AFCConnectionRef conn, const char *sourcePath, const char *destPath) /* DEPRECATED_ATTRIBUTE */;
     ...
     */
    __attribute__((deprecated)) AFCError AFCLinkPath(AFCConnectionRef conn, uint64_t linkType, const char *sourcePath, const char *destPath) /* DEPRECATED_ATTRIBUTE */;
    
        // MARK: Key Value Interface (Synchronous, deprecated)
     ...
     */
    __attribute__((deprecated)) AFCError AFCKeyValueRead(AFCKeyValueRef kvRef, char **keyOut, char **valueOut) /* DEPRECATED_ATTRIBUTE */;
     ...
     */
    __attribute__((deprecated)) AFCError AFCKeyValueClose(AFCKeyValueRef kvRef) /* DEPRECATED_ATTRIBUTE */;
    
        // MARK: FileRef Interface (Synchronous, deprecated)
    ...
    /*!
     ...
     @param mode mode
     @param fileRefOut fileRef Out
     @result kAFCSuccess or a protocol error code.
     */
    __attribute__((deprecated)) AFCError AFCFileRefOpen(AFCConnectionRef conn, const char *remotePath, uint64_t mode,  AFCFileRef *fileRefOut) /* DEPRECATED_ATTRIBUTE */;
     ...
     */
    __attribute__((deprecated)) AFCError AFCFileRefRead(AFCConnectionRef conn, AFCFileRef ref, void *buf, size_t *lengthInOut) /* DEPRECATED_ATTRIBUTE */;
     ...
     */
    __attribute__((deprecated)) AFCError AFCFileRefWrite(AFCConnectionRef conn, AFCFileRef ref, const void *buf, size_t writeLength) /* DEPRECATED_ATTRIBUTE */;
     ...
     */
    __attribute__((deprecated)) AFCError AFCFileRefClose(AFCConnectionRef conn, AFCFileRef ref) /* DEPRECATED_ATTRIBUTE */;
     ...
     */
    __attribute__((deprecated)) AFCError AFCFileRefSeek(AFCConnectionRef conn, AFCFileRef ref, uint64_t offset, uint64_t whence) /* DEPRECATED_ATTRIBUTE */;
     ...
     */
    __attribute__((deprecated)) AFCError AFCFileRefTell(AFCConnectionRef conn, AFCFileRef ref, uint64_t *offsetOut) /* DEPRECATED_ATTRIBUTE */;
     ...
     */
    __attribute__((deprecated)) AFCError AFCFileRefSetFileSize(AFCConnectionRef conn, AFCFileRef ref, uint64_t fileSize) /* DEPRECATED_ATTRIBUTE */;
    ...
    /*!
     ...
     @result kAFCSuccess or a protocol error code.
     */
    __attribute__((deprecated)) AFCError AFCFileRefLock(AFCConnectionRef conn, AFCFileRef ref, bool exclusive) /* DEPRECATED_ATTRIBUTE */;
    ...
    /*!
     ...
     @result kAFCSuccess or a protocol error code.
     */
    __attribute__((deprecated)) AFCError AFCFileRefUnlock(AFCConnectionRef conn, AFCFileRef ref) /* DEPRECATED_ATTRIBUTE */;
    ...
    CFTypeID AFCConnectionGetTypeID(void);
     ...
     */
    AFCConnectionRef AFCConnectionCreate(CFAllocatorRef allocator, CFSocketNativeHandle fd, Boolean closeOnInvalidate, AFCConnectionCallBack callBack, void *connectionInfo);
    ...
    /*!
     ...
     This function will be called whenever an operation has completed processing, and when the connection is about to be invalidated.
     */
    void AFCConnectionSetCallBack(AFCConnectionRef conn, AFCConnectionCallBack callBack);
    ...
    /*!
     ...
     Thread safe.
     */
    void AFCConnectionInvalidate(AFCConnectionRef conn);
    ...
    /*!
     ...
     @discussion -
     */
    Boolean AFCConnectionIsValid(AFCConnectionRef conn);
    ...
    /*!
     ...
     @discussion -
     */
    AFCDomainError AFCConnectionScheduleWithRunLoop(AFCConnectionRef conn, CFRunLoopRef runLoop, CFStringRef runLoopMode);
    ...
    /*!
     ...
     @discussion -
     */
    void AFCConnectionUnscheduleFromRunLoop(AFCConnectionRef conn, CFRunLoopRef runLoop, CFStringRef runLoopMode);
     ...
     */
    AFCDomainError AFCConnectionSubmitOperation(AFCConnectionRef conn, AFCOperationRef op);
     ...
     */
    AFCDomainError AFCConnectionProcessOperation(AFCConnectionRef conn, AFCOperationRef op, CFTimeInterval seconds);
    ...
    /*!
     ...
     Intended for processing operations without a run loop.
     */
    AFCDomainError AFCConnectionProcessOperations(AFCConnectionRef conn, CFTimeInterval timeoutSeconds);
     ...
     */
    void AFCConnectionSetContext(AFCConnectionRef conn, void *context);
     ...
     */
    void AFCConnectionSetDisposeSecureContextOnInvalidate(AFCConnectionRef conn, bool dispose);
     ...
     */
    time_t AFCConnectionGetIOTimeout(AFCConnectionRef conn);
     ...
     */
    void AFCConnectionSetIOTimeout(AFCConnectionRef conn, time_t timeout);
    ...
    const CFStringRef kAFCErrorDomain;
     ...
     */
    CFTypeID AFCFileDescriptorGetTypeID(void);
     ...
     */
    AFCOperationRef AFCFileDescriptorCreateReadOperation(AFCFileDescriptorRef desc, uint8_t *buffer, CFAllocatorRef bufferDeallocator, CFIndex length, void *operationInfo);
     ...
     */
    AFCOperationRef AFCFileDescriptorCreateReadAtPositionOperation(AFCFileDescriptorRef desc, uint8_t *buffer, CFAllocatorRef bufferDeallocator, CFIndex length, UInt64 position, void *operationInfo);
     ...
     */
    AFCOperationRef AFCFileDescriptorCreateWriteOperation(AFCFileDescriptorRef desc, CFDataRef data, void *operationInfo);
    ...
    /*!
     ...
     The result object for this operation is a kCFNull object.
     */
    AFCOperationRef AFCFileDescriptorCreateWriteAtPositionOperation(AFCFileDescriptorRef desc, CFDataRef data, UInt64 position, void *operationInfo);
    ...
    /*!
     ...
     The result object for this operation is a kCFNull object.
     */
    AFCOperationRef AFCFileDescriptorCreateSetPositionOperation(AFCFileDescriptorRef desc, CFIndex seek_type, SInt64 position, void *operationInfo);
     ...
     */
    AFCOperationRef AFCFileDescriptorCreateGetPositionOperation(AFCFileDescriptorRef desc, void *operationInfo);
    ...
    /*!
     ...
     The result object for this operation is a kCFNull object.
     */
    AFCOperationRef AFCFileDescriptorCreateSetSizeOperation(AFCFileDescriptorRef desc, UInt64 size, void *operationInfo);
    ...
    /*!
     ...
     The result object for this operation is a kCFNull object.
     */
    AFCOperationRef AFCFileDescriptorCreateLockOperation(AFCFileDescriptorRef desc, Boolean exclusive, void *operationInfo);
    ...
    /*!
     ...
     The result object for this operation is a kCFNull object.
     */
    AFCOperationRef AFCFileDescriptorCreateUnlockOperation(AFCFileDescriptorRef desc, void *operationInfo);
    ...
    /*!
     ...
     The result object for this operation is a kCFNull object.
     */
    AFCOperationRef AFCFileDescriptorCreateCloseOperation(AFCFileDescriptorRef desc, void *operationInfo);
    ...
    /*!
     ...
     The result object for this operation is a kCFNull object.
     */
    AFCOperationRef AFCFileDescriptorCreateSetImmutableHintOperation(AFCFileDescriptorRef desc, Boolean immutable, void *operationInfo);
     ...
     */
    void AFCFileDescriptorInvalidate(AFCFileDescriptorRef desc);
     ...
     */
    Boolean AFCFileDescriptorIsValid(AFCFileDescriptorRef desc);
     ...
     */
    CFTypeID AFCOperationGetTypeID(void);
     ...
     */
    CFTypeRef AFCOperationGetResultObject(AFCOperationRef op);
     ...
     */
    AFCOperationState AFCOperationGetState(AFCOperationRef op);
     ...
     */
    void *AFCOperationGetContext(AFCOperationRef op);
     ...
     */
    void AFCOperationSetContext(AFCOperationRef op, void *context);
     ...
     */
    AFCDomainError AFCOperationGetResultStatus(AFCOperationRef op);
     ...
     */
    CFDictionaryRef AFCOperationCreatePacketHeaderDictionary(AFCOperationRef op);
     ...
     */
    CFDataRef AFCOperationCopyPacketData(AFCOperationRef op);
     ...
     */
    AFCOperationRef AFCOperationCreateGetDeviceInfo(CFAllocatorRef allocator, void *operationInfo);
    ...
    /*!
     ...
     Returns an AFCOperation object, or NULL if there were no resources available to create it.
     */
    AFCOperationRef AFCOperationCreateGetFileInfo(CFAllocatorRef allocator, CFStringRef remotePath, void *operationInfo);
    ...
    /*!
     ...
     Returns an AFCOperation object, or NULL if there were no resources available to create it.
     */
    AFCOperationRef AFCOperationCreateGetConnectionInfo(CFAllocatorRef allocator, void *operationInfo);
    ...
    /*!
     ...
     Returns an AFCOperation object, or NULL if there were no resources available to create it.
     */
    AFCOperationRef AFCOperationCreateSetConnectionOptions(CFAllocatorRef allocator, CFDictionaryRef options, void *operationInfo);
    ...
    /*!
     ...
     Returns an AFCOperation object, or NULL if there were no resources available to create it.
     */
    AFCOperationRef AFCOperationCreateRemovePath(CFAllocatorRef allocator, CFStringRef remotePath, void *operationInfo);
    ...
    /*!
     ...
     Returns an AFCOperation object, or NULL if there were no resources available to create it.
     */
    AFCOperationRef AFCOperationCreateRenamePath(CFAllocatorRef allocator, CFStringRef sourcePath, CFStringRef destPath, void *operationInfo);
    ...
    /*!
     ...
     Returns an AFCOperation object, or NULL if there were no resources available to create it.
     */
    AFCOperationRef AFCOperationCreateSetModTime(CFAllocatorRef allocator, CFStringRef path, UInt64 modTimeNanoseconds, void *operationInfo);
    ...
    /*!
     ...
     Returns an AFCOperation object, or NULL if there were no resources available to create it.
     */
    AFCOperationRef AFCOperationCreateLinkPath(CFAllocatorRef allocator, CFIndex linkType, CFStringRef sourcePath, CFStringRef destPath, void *operationInfo);
    ...
    /*!
     ...
     Returns an AFCOperation object, or NULL if there were no resources available to create it.
     */
    AFCOperationRef AFCOperationCreateReadDirectory(CFAllocatorRef allocator, CFStringRef remotePath, void *operationInfo);
    ...
    /*!
     ...
     Returns an AFCOperation object, or NULL if there were no resources available to create it.
     */
    AFCOperationRef AFCOperationCreateMakeDirectory(CFAllocatorRef allocator, CFStringRef remotePath, void *operationInfo);
    ...
    /*!
     ...
     Returns an AFCOperation object, or NULL if there were no resources available to create it.
     */
    AFCOperationRef AFCOperationCreateOpenFile(CFAllocatorRef allocator, CFStringRef remotePath, CFIndex mode, void *operationInfo);
    ...
    /*!
     ...
     Returns an AFCOperation object, or NULL if there were no resources available to create it.
     */
    AFCOperationRef AFCOperationCreateGetFileHash(CFAllocatorRef allocator, CFStringRef remotePath, void *operationInfo);
    ...
    /*!
     ...
     Returns an AFCOperation object, or NULL if there were no resources available to create it.
     */
    AFCOperationRef AFCOperationCreateGetFileHashWithRange(CFAllocatorRef allocator, CFStringRef remotePath, uint64_t rangeStart, uint64_t rangeLength, void *operationInfo);
    ...
    /*!
     ...
     Returns an AFCOperation object, or NULL if there were no resources available to create it.
     */
    AFCOperationRef AFCOperationCreateGetSizeOfPathContents(CFAllocatorRef allocator, CFStringRef remotePath, uint64_t options, void *operationInfo);
    ...
    /*!
     ...
     Returns an AFCOperation object, or NULL if there were no resources available to create it.
     */
    AFCOperationRef AFCOperationCreateRemovePathAndContents(CFAllocatorRef allocator, CFStringRef remotePath, void *operationInfo);
