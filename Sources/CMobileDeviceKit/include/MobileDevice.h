...
#if XCFARMEWORK
#include <MobileDeviceKit/MobileDeviceError.h>
#include <MobileDeviceKit/AMDeviceDiscovery.h>
#include <MobileDeviceKit/AMDBase.h>
        //#include <MobileDeviceKit/AMDevicePowerAssertion.h>
        //#include <MobileDeviceKit/AMDevicePreflightOperation.h>
        //#include <MobileDeviceKit/AMDeviceWakeupOperation.h>
        //#include <MobileDeviceKit/MobileRestore.h>
#else
#include "MobileDeviceError.h"
#include "AMDeviceDiscovery.h"
#include "AMDBase.h"
        //#include "AMDevicePowerAssertion.h"
        //#include "AMDevicePreflightOperation.h"
        //#include "AMDeviceWakeupOperation.h"
        //#include "MobileRestore.h"
#endif
...
#define kAMDDiskUsageFactoryDomain                CFSTR("com.apple.disk_usage.factory")
...
#define kAMDExpired             CFSTR("Expired")
     ...
     */
    CFTypeID AMDeviceGetTypeID(void);
    
        /// return device udid
        /// @param device type of am_device
    
    /*!
     * @function AMDeviceGetName
     * @abstract Get the Unique Device ID for AMDevice objects.
     * @result The Unique Device ID for AMDevice objects.
     * @discussion Don't cache, this can change. Use to determine whether
     * or not an object is am AMDevice.
     */
    CFStringRef AMDeviceGetName(AMDeviceRef device);
     ...
     */
    void AMDeviceSetUserInfo(AMDeviceRef device, void *pUserInfo, bool pUserInfoIsCFType);
     ...
     */
    void *AMDeviceGetUserInfo(AMDeviceRef device);
     ...
     */
    enum WirelessBuddyOptions {
        kAMDWirelessBuddy = 1 << 0, kAMDSyncOverWifi = 1 << 1,
    };
     ...
     * See enum WirelessBuddyOptions for a description of the options.
     */
    AMDError AMDeviceGetWirelessBuddyFlags(AMDeviceRef device, CFOptionFlags *flags_out);
     ...
     */
    uint32_t AMDeviceCopyDeviceLocation(AMDeviceRef device);
     ...
     */
    bool AMDeviceIsValid(AMDeviceRef device);
     ...
     */
    unsigned int AMDeviceIsPaired(AMDeviceRef device);
     ...
     */
    AMDeviceInterfaceConnectionType AMDeviceGetInterfaceType(AMDeviceRef device);
    
    /*
     * Get the interface speed for communicating with this device.
     */
    UInt32 AMDeviceGetInterfaceSpeed(AMDeviceRef device);
     ...
     */
    CFPropertyListRef AMDeviceCopyValueWithError(AMDeviceRef device, CFStringRef domain, CFStringRef key, AMDError *error_out);
    ...
    AMDError AMDeviceSetValue(AMDeviceRef device, CFStringRef domain, CFStringRef key, CFTypeRef value);
    
    /*
     * Remove a value on the device.
     */
    
    AMDError AMDeviceRemoveValue(AMDeviceRef device, CFStringRef domain, CFStringRef key);
    
    AMDError AMDeviceRetain(AMDeviceRef device);
    
    AMDError AMDeviceRelease(AMDeviceRef device);
     ...
     */
    AMDError AMDevicePair(AMDeviceRef device);
     ...
     */
    AMDError AMDevicePairWithOptions(AMDeviceRef device, CFDictionaryRef options);
...
#define kAMDPairingChallenge            CFSTR("PairingChallenge")
     ...
     * a non-USB device.
     */
    AMDError AMDeviceExtendedPairWithOptions(AMDeviceRef device, CFDictionaryRef options, CFDictionaryRef *extendedResponse);
    
    /*
     * Unpair with the device.
     */
    AMDError AMDeviceUnpair(AMDeviceRef device);
    
    AMDError AMDeviceCopyPairedWatch(AMDeviceRef device);
     ...
     */
    AMDError AMDeviceValidatePairing(AMDeviceRef device);
     ...
     */
    AMDError AMDeviceActivate(AMDeviceRef device, CFDictionaryRef activationRecord);
     ...
     */
    AMDError AMDeviceDeactivate(AMDeviceRef device);
    ...
    AMDError AMDeviceStartService(AMDeviceRef device, CFStringRef service, CFSocketNativeHandle *socket_out, SSL **ssl);
    
    /* This is deprecated. Use AMDeviceSecureStartService() which is both more general and more better. */
    AMDError AMDeviceStartServiceWithOptions(AMDeviceRef device, CFStringRef service, CFDictionaryRef options, CFSocketNativeHandle *socket_out);
...
#define kAMDOptionCloseOnInvalidate         CFSTR("CloseOnInvalidate")
     ...
     */
    AMDError AMDeviceSecureStartService(AMDeviceRef device, CFStringRef service, CFDictionaryRef options, AMDServiceConnectionRef *service_out);
     ...
     */
    int AMDeviceCopyAuthInstallPreflightOptions(AMDeviceRef device, CFDictionaryRef baseOptions, CFDictionaryRef *outPreflightOptions);
     ...
     */
    int AMDeviceRequestAbbreviatedSendSync(AMDeviceRef device, CFDataRef uniqueBuildID, CFDictionaryRef *outResponse);
     ...
     */
    CFStringRef AMDCopySystemBonjourUniqueID(CFDictionaryRef options);
     ...
     * No options are currently supported. Unsupported options are ignored.
     */
    AMDError AMDCopyAuthenticationIdentityForDevice(CFStringRef someIdentifier, CFDictionaryRef options, CFDictionaryRef *identity_out);
     ...
     */
    AMDError AMDCopyUDIDForPairingIdentity(CFDataRef pairingIdentity, CFStringRef *udid_out);
